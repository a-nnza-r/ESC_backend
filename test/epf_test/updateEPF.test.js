...
describe("updateEPF", () => {
  ...
  test("Test ID: 10 - Invalid Student ID", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
  ...
  test("Test ID: 11 - Invalid Contact Number", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
  ...
  test("Test ID: 12 - Invalid Email Format", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
  ...
  test("Test ID: 13 - Invalid Student ID in List", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
  ...
  test("Test ID: 14 - Invalid Value for Money", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
  ...
  test("Test ID: 15 - Invalid Value for Money in List", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
  ...
  test("Test ID: 16 - Invalid Value for Quantity in List", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
  ...
  test("Test ID: 17 - Invalid Datetime format for Event Schedule", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
  ...
  test("Test ID: 18 - Invalid Date format in List", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
  ...
  test("Test ID: 19 - Invalid Time format in List", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
  ...
  test("Test ID: 20 - Invalid Status Type", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
  ...
  test("Test ID: 22 - D11 amount invalid value", async () => {
    ...
    ).rejects.toThrow("Invalid value for amount");
  });

  test("Test ID: 23 - C2 date invalid", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
      "updateEPF_test23.json"
    );
    const jsonData = fs.readFileSync(jsonFilePath, "utf-8");
    const data = JSON.parse(jsonData);
  ...
  test("Test ID: 24 - C3 date invalid", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
      "updateEPF_test24.json"
    );
    const jsonData = fs.readFileSync(jsonFilePath, "utf-8");
    const data = JSON.parse(jsonData);
  ...
  test("Test ID: 25 - C3 clean up date invalid", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
      "updateEPF_test25.json"
    );
    const jsonData = fs.readFileSync(jsonFilePath, "utf-8");
    const data = JSON.parse(jsonData);
  ...
  test("Test ID: 26 - C2 time invalid", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
      "updateEPF_test26.json"
    );
    const jsonData = fs.readFileSync(jsonFilePath, "utf-8");
    const data = JSON.parse(jsonData);
  ...
  test("Test ID: 27 - C3 time invalid", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
      "updateEPF_test27.json"
    );
    const jsonData = fs.readFileSync(jsonFilePath, "utf-8");
    const data = JSON.parse(jsonData);
  ...
  test("Test ID: 28 - C3_cleanup_time invalid", async () => {
    const jsonFilePath = path.join(
      __dirname,
      "updateEPF_testjson",
      "updateEPF_test28.json"
    );
    const jsonData = fs.readFileSync(jsonFilePath, "utf-8");
    const data = JSON.parse(jsonData);
